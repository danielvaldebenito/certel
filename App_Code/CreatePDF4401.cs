...
public class CreatePDF4401
{
    ...
    public void DefineContentSection(Document document)
    {
        ...
        row.VerticalAlignment = VerticalAlignment.Center;
        row.Cells[1].AddParagraph("INSPECCIÓN NORMA NCh440/1:2014 \n ANEXO A\n Lista de verificación técnica Nch440/1:2014 para la inspección de ascensores y montacargas eléctricos.");
        ...
        row.Cells[2].AddParagraph(string.Format("INSPECCIÓN FASE {0} \n Check List \n Inspección del elevador NCh440/1:2014", ToRoman(Inspeccion.Fase)));
    ...
    public void BreveIntroAndAlcance()
    {
        ...
        subpoint = 1;
        Paragraph parrafo1 = section.AddParagraph(string.Format("{0} \tEl presente  servicio tiene por objeto, dar a conocer las observaciones necesarias a resolver bajo los criterios de inspección de la norma NCh-ISO 17020:2012, NCh440/1:2014 y Nch2840/1:2014, para la auditoría del elevador del edificio de la referencia, y establecer los requisitos de seguridad que debe cumplir para proteger a los usuarios y/o a los objetos contra los diferentes riesgos de accidentes asociados a la instalación y al funcionamiento del mismo. ", point + "." + subpoint + "."));
        parrafo1.Style = "Parrafo";
        subpoint++;
        parrafo1 = section.AddParagraph(string.Format("{0} \tEl objetivo es verificar el estado actual del elevador, respecto de la norma NCh440/1:2014 y NCh2840/1:2014, y ver si cumple con los requisitos de construcción e instalación de las mismas; comprobar que se mantiene en condiciones de funcionamiento seguro, tanto para los usuarios del elevador, como para el personal que realiza el servicio de mantenimiento del {1}", point + "." + subpoint + ".", Inspeccion.Aparato.Nombre));
        subpoint++;
        parrafo1.Style = "Parrafo";
        parrafo1 = section.AddParagraph(string.Format("{0} \tLa norma Nch2840/1:2014 especifica los requisitos de seguridad que deben cumplir los ascensores y montacargas eléctricos emplazados en edificaciones cuyo permiso de edificación haya sido otorgado con posterioridad al 24 de octubre de 2010.", point + "." + subpoint + "."));
        subpoint++;
        parrafo1.Style = "Parrafo";
