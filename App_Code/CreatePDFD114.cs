...
public class CreatePDFD114
{
    ...
    public static int TipoInforme = 1;
    public string Rendered { get; set; }
    public CreatePDFD114(Inspeccion inspeccion)
    {
    ...
    public void Referencias()
    {
        ...
        texto.Style = "Parrafo";
        texto = section.AddParagraph(string.Format("{0}.{1}	NCh3395/1:2016 Equipos de transporte vertical - Parte 1: Requisitos para la inspección de ascensores y montacargas eléctricos existentes.", point, subpoint));
        texto.Style = "Parrafo";
        subpoint++;
    ...
    public void ObservacionesNormativasYTecnicas()
    {
        ...
        Paragraph texto = section.AddParagraph(string.Format("El edificio donde está emplazado el {0},  fue construido con anterioridad al  24 de octubre de 2010, y constituye la condición de ser un {0} existente. Por tanto, el {0} es inspeccionado bajo la norma NCh3395/1:2016, según la ley 20.296.", Inspeccion.Aparato.Nombre));
        texto.Style = "Parrafo";
    ...
    public void Conclusiones()
    {
        ...
        switch(tipoCalificacion) 
        {
            ...
            case 1: // CALIFICA SIN OBSERVACIONES
                ...
                texto.Style = "Parrafo";
                texto = section.AddParagraph(string.Format("El certificado de inspección técnica y normativa denominado Certificado de Inspección {1}, deberá ser ingresado a la Dirección de Obras Municipales respectiva, por el propietario o por el administrador, según corresponda, antes del vencimiento del plazo que tiene la instalación para certificarse, y dentro de un plazo no superior a {0} días contados desde la fecha de emisión de la certificación.", "30", Inspeccion.TipoFuncionamientoAparato.Descripcion));
                texto.Style = "Parrafo";
                texto = section.AddParagraph(string.Format("Se procederá entonces, a emitir el certificado de inspección {1} y de experiencia del elevador, el que estará disponible para su despacho en un plazo máximo de {0} días hábiles.", "5", Inspeccion.TipoFuncionamientoAparato.Descripcion));
                texto.Style = "Parrafo";      
                break;
        }
