...
/// </summary>
public class CreatePDF4401OF2000
{
    ...
    public static string NormaPrincipalNombre = "NCh2840/1:2014";
    public string Rendered { get; set; }
    public static int TipoInforme = 2;
    public CreatePDF4401OF2000(Inspeccion inspeccion)
    {
    ...
    public void DefineContentSection(Document document)
    {
        ...
        row.VerticalAlignment = VerticalAlignment.Center;
        row.Cells[1].AddParagraph("INSPECCIÓN NORMA NCh440/1:Of2000 \n ANEXO A\n Lista de verificación técnica NCh440/1:Of2000 para la inspección de ascensores y montacargas eléctricos.");
        ...
        row.Cells[2].AddParagraph(string.Format("INSPECCIÓN FASE {0} \n Check List \n Inspección del elevador NCh440/1:Of2000", ToRoman(Inspeccion.Fase)));
        ...
        parrafo.Format.Font.Bold = true;
        parrafo.Format.Font.Size = 8;
        parrafo = row.Cells[4].AddParagraph("10-04-2018");
        parrafo.Format.Font.Bold = true;
        parrafo.Format.Font.Size = 8;
        row.Format.Alignment = ParagraphAlignment.Center;
        row.VerticalAlignment = VerticalAlignment.Center;
        ...
        parrafo.Format.Font.Bold = true;
        parrafo.Format.Font.Size = 8;
        parrafo = row.Cells[4].AddParagraph("12-04-2016");
        parrafo.Format.Font.Bold = true;
        parrafo.Format.Font.Size = 8;
        row.Format.Alignment = ParagraphAlignment.Center;
        row.VerticalAlignment = VerticalAlignment.Center;
        ...
        parrafo.Format.Font.Bold = true;
        parrafo.Format.Font.Size = 8;
        parrafo = row.Cells[4].AddParagraph("DI - 113");
        parrafo.Format.Font.Bold = true;
        parrafo.Format.Font.Size = 8;
        parrafo.Format.Font.Bold = true;
        parrafo.Format.Font.Size = 8;
    ...
    public void BreveIntroAndAlcance()
    {
        ...
        subpoint = 1;
        Paragraph parrafo1 = section.AddParagraph(string.Format("{0} \tEl presente  servicio tiene por objeto, dar a conocer las observaciones necesarias a resolver bajo los criterios de inspección de la norma NCh-ISO 17020:2012, NCh440/1:Of2000 y Nch2840/1:Of2004, para la auditoría del elevador del edificio de la referencia, y establecer los requisitos de seguridad que debe cumplir para proteger a los usuarios y/o a los objetos contra los diferentes riesgos de accidentes asociados a la instalación y al funcionamiento del mismo. ", point + "." + subpoint + "."));
        parrafo1.Style = "Parrafo";
        subpoint++;
        parrafo1 = section.AddParagraph(string.Format("{0} \tEl objetivo es verificar el estado actual del elevador, respecto de la norma NCh440/1:Of2000 y NCh2840/1:Of2004, y ver si cumple con los requisitos de construcción e instalación de las mismas; comprobar que se mantiene en condiciones de funcionamiento seguro, tanto para los usuarios del elevador, como para el personal que realiza el servicio de mantenimiento del {1}", point + "." + subpoint + ".", Inspeccion.Aparato.Nombre));
        subpoint++;
        parrafo1.Style = "Parrafo";
        parrafo1 = section.AddParagraph(string.Format("{0} \tLa norma Nch2840/1:Of2004 especifica los requisitos de seguridad que deben cumplir los ascensores y montacargas eléctricos emplazados en edificaciones cuyo permiso de edificación haya sido otorgado con posterioridad al 24 de octubre de 2010.", point + "." + subpoint + "."));
        subpoint++;
        parrafo1.Style = "Parrafo";
    ...
    public void Referencias()
    {
        ...
        texto.Style = "Parrafo";
        texto = section.AddParagraph(string.Format("{0}.{1}	Instituto nacional de normalización y INN: Nch440/1:2014 \"Construccion - Elevadores - Requisitos de seguridad e instalación - Parte 1: 'Ascensores y montacargas eléctricos'\".", point, subpoint));
        texto.Style = "Parrafo";
        subpoint++;
        texto = section.AddParagraph(string.Format("{0}.{1}	Instituto Nacional de Normalización, INN: Nch2840/1:2014 \"Construcción - Elevadores - Procedimientos de inspección - Parte 1 'Ascensores y montacargas eléctricos'\".", point, subpoint));
        texto.Style = "Parrafo";
        subpoint++;
        texto = section.AddParagraph(string.Format("{0}.{1}	DI - 117. \"Procedimiento de Inspección de Elevadores\".", point, subpoint));
        texto.Style = "Parrafo";
        subpoint++;
        texto = section.AddParagraph(string.Format("{0}.{1}	Anexo A de la Norma Nch2840/1:2014 \"Lista de verificación para la Inspección de ascensores y montacargas eléctricos\".", point, subpoint));
        texto.Style = "Parrafo";
        subpoint++;
    ...
    public void Antecedentes()
    {
        ...
        Paragraph parrafo = section.AddParagraph(string.Format("En esta inspección se verifica el cumplimiento de la norma NCh440/1:2014 y Nch2840/1:2014, asociadas a las instalaciones y el funcionamiento del {0}.", Inspeccion.Aparato.Nombre));
        parrafo.Style = "Parrafo";
    ...
    public void DefineTableOfContents(Document document)
    {
        ...
        paragraph.Format.SpaceAfter = "0.5cm";
        section.PageSetup.TopMargin = 160;
