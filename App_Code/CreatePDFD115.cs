...
public class CreatePDFD115
{
    ...
    public static string NormaPrincipalNombre = "NCh3365";
    ...
    public void Referencias()
    {
        ...
        texto.Style = "Parrafo";
        texto = section.AddParagraph(string.Format("{0}.{1}	Instituto nacional de normalización, INN: NCh3365:2015 \"Requisitos para equipos de transporte vertical — Ascensores y montacargas inclinados o funiculares\".", point, subpoint));
        texto.Style = "Parrafo";
        subpoint++;
    ...
    public void Antecedentes()
    {
        ...
        Paragraph parrafo = section.AddParagraph(string.Format("En esta inspección se verifica el cumplimiento de la norma NCh3395, asociada a las instalaciones y el funcionamiento del {0}.", Inspeccion.Aparato.Nombre));
        parrafo.Style = "Parrafo";
