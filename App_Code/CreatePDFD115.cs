...
public class CreatePDFD115
{
    ...
    public static int NormaPrincipal = 22;
    public static int TipoInforme = 4;
    public static string NormaPrincipalNombre = "NCh3365/1:2015";
    public string Rendered { get; set; }
    public CreatePDFD115(Inspeccion inspeccion)
    {
    ...
    public void DefineContentSection(Document document)
    {
        ...
        row.Cells[2].AddParagraph(string.Format("INSPECCIÓN FASE {0} \n Check List \n Inspección del elevador NCh3365/1:2015", ToRoman(Inspeccion.Fase)));
        ...
        parrafo.Format.Font.Bold = true;
        parrafo.Format.Font.Size = 8;
        parrafo = row.Cells[4].AddParagraph("DI - 115");
        parrafo.Format.Font.Bold = true;
        parrafo.Format.Font.Size = 8;
        parrafo.Format.Font.Bold = true;
        parrafo.Format.Font.Size = 8;
    ...
    public void BreveIntroAndAlcance()
    {
        ...
        subpoint = 1;
        Paragraph parrafo1 = section.AddParagraph(string.Format("{0} \tEl presente  servicio tiene por objeto, enviar un informe de observaciones necesarias a resolver bajo los criterios de inspección de la norma NCh-ISO 17020:2012 y NCh3365/1:2015, para la auditoría del elevador del edificio de la referencia, y establecer los requisitos de seguridad que debe cumplir el elevador para proteger a los usuarios y/o a los objetos contra los diferentes riesgos de accidentes asociados a la instalación y al funcionamiento del mismo.", point + "." + subpoint + "."));
        parrafo1.Style = "Parrafo";
        subpoint++;
        parrafo1 = section.AddParagraph(string.Format("{0} \tEl objetivo es verificar el estado actual del elevador, respecto de la norma NCh3365/1:2015, y ver si cumple con los requisitos de construcción e instalación de la misma; comprobar que se mantiene en condiciones de funcionamiento seguro, tanto para los usuarios del elevador, como para el personal que realiza el servicio de mantenimiento del {1}", point + "." + subpoint + ".", Inspeccion.Aparato.Nombre));
        subpoint++;
        parrafo1.Style = "Parrafo";
        parrafo1 = section.AddParagraph(string.Format("{0} \tEsta norma establece los requisitos mínimos de diseño, instalación y seguridad para elevadores inclinados y funiculares destinados al transporte de pasajeros y carga acompañada de pasajeros; aplica a elevadores con una inclinación hasta 75° respecto del plano horizontal; incluye ascensores o montacargas inclinados o funiculares con sala de máquinas.", point + "." + subpoint + "."));
        subpoint++;
        parrafo1.Style = "Parrafo";
    ...
    public void Referencias()
    {
        ...
        texto.Style = "Parrafo";
        texto = section.AddParagraph(string.Format("{0}.{1}	Instituto nacional de normalización, INN: NCh3365/1:2015 \"Requisitos para equipos de transporte vertical — Ascensores y montacargas inclinados o funiculares\".", point, subpoint));
        texto.Style = "Parrafo";
        subpoint++;
    ...
    public void Antecedentes()
    {
        ...
        Paragraph parrafo = section.AddParagraph(string.Format("En esta inspección se verifica el cumplimiento de la norma NCh3395/1:2015, asociada a las instalaciones y el funcionamiento del {0}.", Inspeccion.Aparato.Nombre));
        parrafo.Style = "Parrafo";
    ...
    public void ImagenCabina()
    {
        ...
        string pathImage = HttpContext.Current.Server.MapPath("~/css/images/");
        Image image = section.LastParagraph.AddImage(pathImage + "/cabina115.png");
